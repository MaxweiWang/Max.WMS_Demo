#pragma checksum "D:\Project\Git\WMS\Max.WMS_Demo\Max.WMS.NetCore\Max.WMS.NetCore\Views\Dict\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "97444855761ccbe7f40c38b6edf886b544c342f7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"97444855761ccbe7f40c38b6edf886b544c342f7", @"/Views/Dict/Index.cshtml")]
        ...
        <div class=""row"" style=""padding-bottom:1px;"">
            ...
            WriteLiteral(@"ss=""box-body"">
                        <div class=""input-group"">
                            ...
                            ");
#nullable restore
#line 30 "D:\Project\Git\WMS\Max.WMS_Demo\Max.WMS.NetCore\Max.WMS.NetCore\Views\Dict\Index.cshtml"
                       Write(await Component.InvokeAsync("DictTypeS"));
...
#nullable disable
            WriteLiteral(@"
                        ...
                        <div class=""input-group"" style=""margin-top:5px;margin-left:-10px"">
                            <button v-on:click=""searchL"" name=""search"" type=""submit"" class=""btn btn-success"" style=""margin-left:10px;""><i class=""fa fa-search""></i> 搜字典</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class=""box-body"">
                        <div id=""toolbar"" class=""btn-group"">
                            ...
                            <button id=""btn_edit"" v-on:click=""editL"" type=""button"" class=""btn btn-default"">
                                <span ");
            WriteLiteral(@"class=""glyphicon glyphicon-pencil"" aria-hidden=""true""></span>修改
                            </button>
            ...
            mounted: function () {
                ...
                WriteLiteral(@"add(""active"");
                    ...
                    setTimeout(function () {
                        ...
                        $(""div[class='pull-right search']"")[0].children[0].se");
                WriteLiteral(@"tAttribute(""placeholder"", ""字典名称"");
                    }, 500);
                });
            },
            methods: {
                ...
                editL: function () {
                    ...
                    if (arr.length > 0) {
                        var index = layer.confirm(""您确定要修改吗？"", { btn: [""确定"", ""取消""] }, function () {
                            ...
                            var id = arr[0].DictId;
   ");
                WriteLiteral(@"                         yui.layershow(""修改字典"", ""/Dict/Add?id="" + id, 510, 400);
                        }, function () {
