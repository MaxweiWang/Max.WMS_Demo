#pragma checksum "D:\Project\Git\WMS\Max.WMS_Demo\Max.WMS.NetCore\Max.WMS.NetCore\Views\Reservoirarea\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cf84f73c6d69ddf750af129352060fbb3e28795c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cf84f73c6d69ddf750af129352060fbb3e28795c", @"/Views/Reservoirarea/Index.cshtml")]
    ...
    <section class=""content"">
        <div class=""row"">
            ...
            WriteLiteral(@"chL"" type=""submit"" class=""btn btn-success"" style=""margin-left:10px;""><i class=""fa fa-search""></i> 搜库区</button>
                        </div>
        ...
        var app = new Vue({
            ...
            mounted: function () {
                ...
                _self.$nextTick(function () {
                    //显示active
                    _self.$refs.ReservoirArea.parentNode.parentNode.classList.add(""active"");
                    _self.$refs.ReservoirArea.classList.add(""active"");
...
");
                WriteLiteral(@"                        autoclose: true,
                    ...
                    setTimeout(function () {
                        _self.loadL();
                        $(""div[class='pull-right search']"")[0].children[0].setAttribute(""placeholder"", ""库区编号或名称"");
                    }, 500);
                });
            },
            methods: {
                loadL: function () {
                    ...
                    },
                    {
                        ...
                        field: 'ReservoirAreaNo',
                        title: '库区编号',
                        align: 'center',
                        sortable: true
                    }, {
           ");
                WriteLiteral(@"             field: 'ReservoirAreaName',
                        title: '库区名称',
                        align: 'center',
                        sortable: true
                    }, {
                        ...
                        formatter: function (value, row, index) {
                            return _self");
                WriteLiteral(@".jsonDateFormat(value);
                        }
                    }, {
                        field: 'UName',
                        align: 'center',
                    ...
                    yui.table(""bootstraptable"", ""/Reservoirarea/List"", obj, ""POST"", ""ReservoirareaId"");
                },
                showL: function () {
                    yui.layershow(""添加库区"", ""/Reservoirarea/Add"", 550, 460);
                },
                searchL: function () {
                    $(""#bootstraptable"").bootstrapTable('refresh');
                },
               ");
                WriteLiteral(@" editL: function () {
                    var arr = $(""#bootstraptable"").bootstrapTable('getSelections');
                    if (arr.length > 0) {
                        var index = layer.confirm(""您确定要修改吗？"", { btn: [""确定"", ""取消""] }, function () {
                            layer.close(index);
                            var id = arr[0].ReservoirAreaId;
                            yui.layershow(""修改库区"", ""/Reservoirarea/Add?id="" + id, 550, 460);
                        }, function () {
                ...
                deleteL: function () {
                    ...
                    if (arr.length > 0) {
                        var index = layer.confirm(""您确定要删除吗？"", { btn: [""确定"", ""取消""] }, function () {
                            var ");
                WriteLiteral(@"id = arr[0].ReservoirAreaId;
                            yui.$axiosget('/Reservoirarea/Delete?id=' + id)
